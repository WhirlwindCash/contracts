...
async function deposit() {
  ...
  console.log(`https://bscscan.com/tx/${tx.transactionHash}`)
  return `whirlwindbnb-${AMOUNT}-${netId}-${toHex(deposit.preimage, 62)}`
}

/**
 * Do a native asset withdrawal
...
async function main() {
  ...
  contract = new web3.eth.Contract(require('./build/contracts/NativeWhirlwind.json').abi, CONTRACT_ADDRESS)
